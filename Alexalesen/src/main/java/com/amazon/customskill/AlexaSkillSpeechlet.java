...
public class AlexaSkillSpeechlet implements SpeechletV2{
	...
	private static String confirmEnglish = "Ab jetzt werde ich alle Wörter von englisch   auf deutsch übersetzen.  viel spass beim lesen!";
	private static String confirmDeutsch = "Ab jetzt werde ich alle Wörter von englisch   auf deutsch übersetzen.  viel spass beim lesen!";
	private static enum RecognitionState {Words, EnglishDeutsch};
	private RecognitionState recState;
	private static enum UserIntent {Englisch, Deutsch,Stop};
	...
	public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope)
	{
		...
		default: resp = response(userRequest);
		}   
		return resp;
	}
	...
	private SpeechletResponse evaluateEnglishDeutsch(String userRequest) {
		...
		case Englisch: {
			...
			res = askUserResponse(confirmDeutsch); break;
		} default: {
	...
	private SpeechletResponse evaluateAnswer(String userRequest) throws Exception {
		...
		default:
			text = "dog";
			res = askUserResponse(Translator.translate(text, fromLang, toLang));
			break;
		}
		return res;
	}
